...
public interface AssignmentRepository extends CrudRepository <Assignment, Integer> {
	...
	@Query("select a from Assignment a where a.course.course_id = :course_id order by a.id")
	List<Assignment> findAssignmentByCourseId(@Param("course_id") Integer course_id);
}
